...
public class WordXParser {
     ...
     * forEach开始正则
     */
    Pattern forEachBeginReg;
    /**
     * forEach结束正则
     */
    Pattern forEachEndReg;
    /**
     * 变量表达式正则
     */
    Pattern variableReg;
     ...
     * 编译完的word文档对象
     */
    private final XWPFDocument parsedDoc;
...
//
    ...
    public static class Scope {
        ...
        // 所有作用域
        public static Map<String, Scope> allScopeMap = new HashMap<>();
        ...
        public Scope(String name, String condition) {
            ...
            if (!StrUtil.equals(ROOT, name)) {
                ...
                if (name.indexOf(dot) > -1) {
                    int indexOfSep = name.lastIndexOf(dot);
